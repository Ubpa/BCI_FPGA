...
static int ng1[] = {0, 0};
static int ng2[] = {1, 0};
static unsigned int ng3[] = {10416U, 0U};
static int ng4[] = {2, 0};
static int ng5[] = {7, 0};
...
LAB24:    t154 = (t0 + 4160);
    xsi_vlogvar_assign_value(t154, t4, 0, 0, 1);
    goto LAB2;
...
LAB57:    xsi_vlog_unsigned_bit_combine(t60, 32, t145, 32, t153, 32);
    goto LAB61;
