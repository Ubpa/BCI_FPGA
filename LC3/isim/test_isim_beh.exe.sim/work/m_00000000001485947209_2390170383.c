...
LAB20:    t403 = (t0 + 11552);
    ...
    *((unsigned int *)t413) = (t415 | t409);
    xsi_driver_vfirst_trans(t403, 0, 15);
    t416 = (t0 + 11392);
    *((int *)t416) = 1;
...
LAB148:    t323 = (t0 + 5208U);
    t324 = *((char **)t323);
    goto LAB149;

LAB150:    t323 = (t0 + 5848U);
    t331 = *((char **)t323);
    t323 = ((char*)((ng11)));
    memset(t332, 0, 8);
    t333 = (t331 + 4);
...
LAB175:    *((unsigned int *)t370) = 1;

LAB177:    memset(t367, 0, 8);
    t386 = (t370 + 4);
...
LAB179:    if (*((unsigned int *)t386) != 0)
        goto LAB180;

LAB181:    t393 = (t367 + 4);
    t394 = *((unsigned int *)t367);
    t395 = *((unsigned int *)t393);
    t396 = (t394 || t395);
    if (t396 > 0)
        goto LAB182;

LAB183:    t399 = *((unsigned int *)t367);
    t400 = (~(t399));
...
LAB185:    if (*((unsigned int *)t393) > 0)
        goto LAB186;

LAB187:    if (*((unsigned int *)t367) > 0)
        goto LAB188;

LAB189:    memcpy(t366, t397, 8);
...
LAB182:    t397 = (t0 + 5528U);
    t398 = *((char **)t397);
    goto LAB183;

LAB184:    t397 = ((char*)((ng2)));
    goto LAB185;

LAB186:    xsi_vlog_unsigned_bit_combine(t366, 16, t398, 16, t397, 16);
    goto LAB190;

LAB188:    memcpy(t366, t398, 8);
    goto LAB190;
...
LAB35:    t157 = (t0 + 8648);
    xsi_vlogvar_wait_assign_value(t157, t4, 0, 0, 1, 0LL);
...
LAB89:    xsi_vlog_unsigned_bit_combine(t144, 1, t158, 1, t163, 1);
    goto LAB93;

LAB91:    memcpy(t144, t158, 8);
    goto LAB93;

LAB94:    *((unsigned int *)t4) = 1;
    goto LAB97;

LAB99:    t17 = *((unsigned int *)t4);
    t18 = *((unsigned int *)t14);
    *((unsigned int *)t4) = (t17 | t18);
    t19 = *((unsigned int *)t13);
    t20 = *((unsigned int *)t14);
...
extern void work_m_00000000001485947209_2390170383_init()
{
	static char *pe[] = {(void *)Cont_42_0,(void *)Initial_46_1,(void *)Always_51_2,(void *)Cont_56_3,(void *)Always_85_4};
	xsi_register_didat("work_m_00000000001485947209_2390170383", "isim/test_isim_beh.exe.sim/work/m_00000000001485947209_2390170383.didat");
