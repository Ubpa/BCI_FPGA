...
static int ng2[] = {1, 0};
static int ng3[] = {7, 0};
static unsigned int ng4[] = {10416U, 0U};
...
LAB24:    t102 = (t0 + 4024);
    xsi_vlogvar_assign_value(t102, t4, 0, 0, 1);
    goto LAB2;
...
LAB49:    if (*((unsigned int *)t89) > 0)
        goto LAB50;

LAB51:    if (*((unsigned int *)t61) > 0)
        goto LAB52;

LAB53:    memcpy(t60, t101, 8);
...
LAB50:    xsi_vlog_unsigned_bit_combine(t60, 32, t93, 32, t101, 32);
    goto LAB54;

LAB52:    memcpy(t60, t93, 8);
    goto LAB54;
...
extern void work_m_00000000003542694386_1780509408_init()
{
	...
	xsi_register_didat("work_m_00000000003542694386_1780509408", "isim/UART_isim_beh.exe.sim/work/m_00000000003542694386_1780509408.didat");
